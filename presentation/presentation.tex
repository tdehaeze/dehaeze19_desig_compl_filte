...
\label{sec:org40f8eb6}
\begin{frame}[label={sec:org0a9a28a}]{Sensor Fusion Architecture - Noise Filtering}
\vspace{-1em}
\begin{columns}
...
\begin{frame}[label={sec:orgbe85fff}]{Sensor Fusion Architecture - Robustness}
\begin{columns}
...
\begin{frame}[label={sec:org44eb698}]{Shaping of Complementary Filters using \(\mathcal{H}_\infty\) synthesis}
\vspace{-1em}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgafaab6e}]{Validation of the proposed synthesis method}
\begin{center}
\includegraphics[scale=1,width=0.85\linewidth]{figs/hinf_synthesis_results.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2fc9535}]{Complementary Filters Specifications - Weights}
\onslide{\begin{cbox}[]{blue}{}
\begin{center}
\begin{tabular}{ll}
...
\begin{frame}[label={sec:orgc18d54e}]{\(\mathcal{H}_\infty\) Synthesis}
\begin{center}
\includegraphics[scale=1,width=0.8\linewidth]{figs/comp_fir_ligo_hinf.pdf}
\end{center}
\end{frame}
\end{document}