...
\label{sec:orgdcf129e}
\begin{frame}[label={sec:orgde41700}]{Sensor Fusion Architecture - Noise Filtering}
\vspace{-1em}
\begin{columns}
...
\begin{frame}[label={sec:orgf3b5e26}]{Sensor Fusion Architecture - Robustness}
\begin{columns}
...
\begin{frame}[label={sec:orgf0b2054}]{Shaping of Complementary Filters using \(\mathcal{H}_\infty\) synthesis}
\vspace{-1em}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org2d6cd37}]{Validation of the proposed synthesis method}
\begin{center}
