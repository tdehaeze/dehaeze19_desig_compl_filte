...
\hypersetup{
 pdfauthor={\IEEEauthorblockN{Dehaeze Thomas\IEEEauthorrefmark{1} and Collette Christophe} \\ \IEEEauthorblockA{Precision Mechatronics Laboratory, ULB\\ Brussels, Belgium\\ Email: \IEEEauthorrefmark{1}dehaeze.thomas@gmail.com}},
...
\section{Discussion}
\label{sec:orgcc9e8fe}
\section{Conclusion}
\label{sec:org7919028}
\label{sec:conclusion}

\section{Acknowledgment}
\label{sec:orgecc7116}
